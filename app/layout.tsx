...
export const metadata:Metadata={
  metadataBase:new URL("https://hermano-padawan.github.io"),
  ...
  alternates:{canonical:"/practica-catala/"},
  robots:{index:true,follow:true},
  openGraph:{title:"Exercicis de català C1 | Practica Català",description:"1.000 exercicis autocorrectius de català C1, gratuïts i sense registre.",url:"/practica-catala/",siteName:"Practica Català",locale:"ca_ES",type:"website"},
};
