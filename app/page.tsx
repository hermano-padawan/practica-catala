...
import balancedBank from "../content/questions/c1-equilibrat-850.json";
...
const topicMeta = [
  ...
  {slug:"ortografia",icon:"Ç",title:"Ortografia",description:"Sibilants, b/v, g/j i consonants finals"},
...
const questions: Question[] = [...questionBank, ...orthographyBank, ...balancedBank]
...
export default function Home(){
  ...
  return <main>
    <header className="header"><a href="#inici" className="logo"><span>ç</span> Practica Català</a><nav><a href="#nivells">Nivells</a><a href="#temes">Temes</a><a href="#practica">Exercicis</a></nav><a href="#practica" className="small-cta">Practica ara</a></header>
    ...
    <section className="levels section" id="nivells"><div className="section-heading"><div><span className="kicker">TRIA EL TEU NIVELL</span><h2>Practica B2 o C1</h2></div><p>Dos bancs independents de 1.000 exercicis, amb progrés separat i sessions autocorrectives.</p></div><div className="level-grid"><article className="level-card muted-card"><div className="level-badge">B1</div><div><h3>Llindar</h3><p>Properament</p></div></article><article className="level-card"><div className="level-badge">B2</div><div><h3>Nivell intermedi</h3><p>1.000 preguntes publicades en blocs pràctics.</p><a href="/b2/">Practicar B2 <span>→</span></a></div></article><article className="level-card blue featured"><div className="level-badge">C1</div><div><h3>Nivell de suficiència</h3><p>{questions.length} preguntes publicades en blocs pràctics.</p><button onClick={()=>start("tots")}>Practicar C1 <span>→</span></button></div></article></div></section>
    ...
    <footer><a href="#inici" className="logo"><span>ç</span> Practica Català</a><div className="footer-center"><p>Exercicis de català, sense complicacions.</p><div className="social-links"><strong>Xarxes socials</strong><a href="https://www.facebook.com/share/1J7WQBFDUF/" target="_blank" rel="noopener noreferrer" aria-label="Practica Català a Facebook">Facebook</a></div><nav aria-label="Informació legal"><a href="/avis-legal/">Avís legal</a><a href="/privacitat/">Privacitat</a><a href="/cookies/">Cookies</a></nav></div><small>Projecte independent · 2026</small></footer>
  </main>
}
