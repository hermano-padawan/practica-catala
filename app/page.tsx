...
export default function Home(){
  ...
  return <main>
    ...
    <footer><a href="#inici" className="logo"><span>ç</span> Practica Català</a><div className="footer-center"><p>Exercicis de català, sense complicacions.</p><nav aria-label="Informació legal"><a href="/practica-catala/avis-legal/">Avís legal</a><a href="/practica-catala/privacitat/">Privacitat</a><a href="/practica-catala/cookies/">Cookies</a></nav></div><small>Projecte independent · 2026</small></footer>
  </main>
}
